...
class Map {
  ...
  fill_special_room(room, monsters) {
    ...
    if (choice == 1) {
      ...
      this.set_cell(room.random_inner_position(this), ALTAR);
    } else if (choice == 4) {
      ...
      this.set_cell(room.random_inner_position(this), PACIFIST_VAMPIRE);
    } else if (choice == 6) {
      this.set_cell(room.random_inner_position(this), HOBBIT);
    } else {
      // chest
