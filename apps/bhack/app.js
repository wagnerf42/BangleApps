 ...
 ######
  ...
  player_move(direction) {
    ...
    if (destination_content >= FIRST_MONSTER && destination_content < FIRST_SPECIAL) {
      ...
      this.in_menu = true;
      if (game.player.hp == 1) {
        E.showMessage("Oh no, you are too weak.").then(() => {game.in_menu = false; game.display()});
      }
