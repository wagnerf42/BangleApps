...
const FIRST_SPECIAL = 22;
const FIRST_ITEM = 27;
const FIRST_MISC = 38;
const VOID = 46;

const POTIONS = 3; // how many different potions in the game
...
const ALTAR = FIRST_MISC + 3;
const PACIFIST_VAMPIRE = FIRST_MISC + 4;
const HOBBIT = FIRST_MISC + 5;
const CHEST = FIRST_MISC + 6;
const MERCHANT = FIRST_MISC + 7;

const GOLD = FIRST_SPECIAL;

let h = require("heatshrink");
// contrast is set at 40
const TILES = require("heatshrink").decompress(atob(""));
...
const DRAINING = 12; // between 3 (weak) and 1 (strong)
...
let MONSTERS_STATS = [
  new Uint16Array([10, 10, 0, 4, 6, 1, 4, 0, 100, 0, 0, 0, 0]), // Player
  new Uint16Array([4, 10, 0, 4, 8, 1, 2, 0, 100, 100, 0, 1, 0]), // Newt
  new Uint16Array([6, 10, 0, 8, 10, 1, 3, 0, 100, 150, 0, 1, 0]), // Ant
  new Uint16Array([10, 10, 0, 6, 6, 1, 4, 0, 100, 400, 0, 1, 0]), // Wolf
...
const ITEMS_STATS = [
  ...
  new Uint16Array([0, 3, 2, 0, 0, 0, 0, 0, 0, 1500, 0, 0, BODY, 0]) // chainmail
];
...
const SPECIAL_ITEMS = ["Gold", "Food", "Life Potion", "Poison", "Strength Potion"];
...
class Creature {
  constructor(monster_type, position) {
    if (monster_type == 0) {
      ...
      this.strength_duration = 0; // number of rounds left for strength potion
    ...
    if ((xdiff == 1 && ydiff == 0) || (xdiff == 0 && ydiff == 1)) {
      ...
      if (this.stats[MOVE_ALGORITHM] == 1) {
        if (xdiff * ydiff < 9) {
          ...
          let cell = game.map.get_cell(destination);
          if (cell == FLOOR) {
            game.map.move(this, destination);
          } else if (cell == ALTAR) {
            game.msg("Lightning suddenly strikes", "#ff8000");
            this.hp = 0;
            this.dies(false);
          }
        }
  ...
  dies(give_xp) {
    ...
    if (this.monster_type == 0) {
      ...
      if (give_xp) {
        ...
        game.map.set_cell(this.position, FLOOR);
      }
...
const SPECIAL_ROOMS = [[GOLD,1,10], [FOUNTAIN,1,10], [ALTAR,1,10], [MERCHANT,3,10], [PACIFIST_VAMPIRE,1,10], [HOBBIT,3,10], [CHEST,1,20]];
...
class Map {
  ...
  fill_special_room(room, monsters) {
    ...
    let possible_rooms = SPECIAL_ROOMS.filter((v) => {return v[1] <= level});
    let weights_sum = possible_rooms.reduce((s, v) => {
        return s + v[2];
    }, 0);
    let wanted = randint(0, weights_sum -1);
    let choice = possible_rooms.find((v) => {
      if (wanted <= v[2]) { return true;} else {
        wanted -= v[2];
        return false;
      }
    })[0];
    if (choice == GOLD) {
      ...
      this.set_cell(room.random_inner_position(this), choice);
    }
  }
  ...
  display() {
    ...
    for (let x = -2; x <= 2; x++) {
      for (let y = -2; y <= 2; y++) {
        ...
        g.drawImage(TILES, (x + 2) * 32, (y + 2) * 32, { frame: 0 });
...
#######
 ######
  ...
  player_move(direction) {
    ...
    } else if (destination_content == HOBBIT) {
      this.in_menu = true;
      if (game.player.gold < 50) {
        E.showAlert("Sorry I don't cook\n for free").then(() => {game.in_menu = false; game.display()});
      } else {
        E.showPrompt("Hey\nYou should\neat more.\n\n50 gold for some meal",{title: "Hobbit Cook"}).then((v) => {
          if (v) {
            game.player.gold -= 50;
            game.player.satiation = 400;
            game.msg("Wow, great meal.")
          }
          game.in_menu = false;
          game.display();
        });
      }
    } else if (destination_content == PACIFIST_VAMPIRE) {
      this.in_menu = true;
      if (game.player.hp == 1) {
        E.showAlert("Oh no, you are too weak.").then(() => {game.in_menu = false; game.display()});
      }
      let price = 8 * this.player.hp;
      E.showPrompt("Hey\nI'll buy some blood\nfor "+price+" gold",{title: "Pacifist Vampire"}).then((v) => {
        if (v) {
          game.player.hp = Math.floor(game.player.hp / 2);
          game.player.gold += price;
        }
        game.in_menu = false;
        game.display();
      });
    } else if (destination_content == ALTAR) {
      if (this.player.piety >= 1000) {
        this.msg("You feel peace");
      } else if (this.player.piety >= 500) {
        this.msg("You feel uneasy");
      } else {
        this.msg("You feel bad");
      }
  ...
  if (game.screen == POTIONS_SCREEN) {
    ...
    if (game.player.potions[potion] != 0) {
      if (potion == 0) {
        ...
        if (game.player.strength_duration == 0) {
          game.player.stats[DMG_BONUS] += 1;
          game.msg("You feel stronger");
        }
        game.player.strength_duration += 100;
      } else {
